...
type EchoResult struct {
	Success *pbapi.Reponse
}

var EchoResult_Success_DEFAULT *pbapi.Reponse

func (p *EchoResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(pbapi.Reponse)
	}
...
func (p *EchoResult) GetSuccess() *pbapi.Reponse {
	if !p.IsSetSuccess() {
...
func (p *kClient) Echo(ctx context.Context, Req *pbapi.Request) (r *pbapi.Reponse, err error) {
	var _args EchoArgs
	_args.Req = Req
