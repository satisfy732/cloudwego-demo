...
func (p *Reponse) InitDefault() {
}

func (p *Reponse) GetMessage() (v string) {
	return p.Message
}
func (p *Reponse) SetMessage(val string) {
	p.Message = val
}

var fieldIDToName_Reponse = map[int16]string{
	1: "message",
}

func (p *Reponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_Reponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *Reponse) ReadField1(iprot thrift.TProtocol) error {
...
func (p *Reponse) Write(oprot thrift.TProtocol) (err error) {

	var fieldId int16
	if err = oprot.WriteStructBegin("Reponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *Reponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("message", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Message); err != nil {
...
func (p *Reponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("Reponse(%+v)", *p)

}

func (p *Reponse) DeepEqual(ano *Reponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *Reponse) Field1DeepEqual(src string) bool {
...
type Echo interface {
	Echo(ctx context.Context, req *Request) (r *Reponse, err error)
}
...
func (p *EchoClient) Echo(ctx context.Context, req *Request) (r *Reponse, err error) {
...
type EchoEchoResult struct {
	Success *Reponse `thrift:"success,0,optional" frugal:"0,optional,Reponse" json:"success,omitempty"`
}
...
var EchoEchoResult_Success_DEFAULT *Reponse

func (p *EchoEchoResult) GetSuccess() (v *Reponse) {
	if !p.IsSetSuccess() {
...
func (p *EchoEchoResult) Field0DeepEqual(src *Reponse) bool {
